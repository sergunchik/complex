...
\begin{lema}[Lema de Goursat, 1883]
\label{l:goursat}
...
\end{multline}
Mas o último integral é pequeno: $|z-z_0|$ é limitado por diâmetro de $\Delta_k$,
...
\end{teorema}
\begin{proof}
\Cref{t:cauchy} de (Goursat-)Cauchy implica que as integrais sobre ciclos $\gamma_r$
