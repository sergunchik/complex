...
são holomorfas no todo $\C$.\footnote{Tais funções são chamadas \emph{inteiras}, cf. \Cref{d:inteira}.}
\end{exem}
...
suponha que não, considere $f(z) = \frac{1}{P(z)}$ e aplique o \cref{t:liouville} de Liouville.}
\end{problema}
