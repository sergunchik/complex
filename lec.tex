...
\[ \lim_{n\to\infty} a_{\sigma 0} + a_{\sigma 1} + \dots + a_{\sigma n} = C \] 
se e somente se $\frac{C-a} \in b \R$.
\end{enumerate}
\end{teorema}
...
\begin{remark}[somabilidade em sentido de Abel]
...
Por examplo
\begin{nalign}
\lim_{t\to 1-} 1-z+z^2-\dots = \frac12, \\
\lim_{t\to 1-} 1-2z+3z^2-\dots = \lim_{t\to 1-} \big(\frac{-1}{1+t}\big)'
= \lim_{t\to 1-} \frac{1}{(1+t)^2} = \frac{1}{(1+1)^2} = \frac14,\\
