...
Então a série de Laurent $\sum_{n\in\Z} c_n (z-a)^n$
converge absolutamente para qualquer $z\in A$.
\end{teorema}
\begin{proof}
...
e a série converge absolutamente.\footnote{
Na verdade, um teorema de Riemann diz que
