...
\section{Derivada logaritmica. Princípio do argumento.}
...
Podemos reformular \Cref{t:dlog} em linguagem de argumento.
\begin{teorema}[Princípio de argumento]
Em presuposições de \Cref{t:dlog} o número $N-P = \sum_{a\in G} \nu_a(f)$
