...
então é equivalente ao \Cref{cauchy-limite}. Tomando $n=m$ obtemos \eqref{2}.
...
Verifique
\begin{nalign}
\lim_{t\to 1-} 1-t+t^2-t^3+t^4-\dots = \frac12, \\
\lim_{t\to 1-} 1-2t+3t^2-\dots
% = \lim_{t\to 1-} \big(\frac{-1}{1+t}\big)'
% = \lim_{t\to 1-} \frac{1}{(1+t)^2} = \frac{1}{(1+1)^2} 
= \frac14,\\
\lim_{t\to 1-} t-\frac{t^2}{2}+\frac{t^3}{3}-\dots = \log 2,\\
\lim_{t\to 1-} t+\frac{t^2}{4}+\frac{t^3}{9}+\dots = \frac{\pi^2}{6},\\
\lim_{t\to 1-} \sum_{n\geq 1} \frac{t^n}{n^k} = \zeta(k),\quad \forall k\geq 2.
\end{nalign}
\end{problema}
