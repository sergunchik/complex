...
$A':= \ol{A}_{r',R'}(a) \subset A$ tal que $z$ é dentro interior dele.
...
e a série geométrica \Cref{eq:series-geometrica}:\footnote{
...
\end{equation*}
converge absolutamente e uniforme no círculo $\gamma_{r'}$.
Então, podemos trocar a orden de soma e integração nas integrais
